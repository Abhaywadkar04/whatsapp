...
import { GET_ALL_MESSAGES_ROUTE, GET_CHANNEL_MESSAGES } from "@/utlis/constants";
...
export const MessageContainer = () => {
  const {selectedChatData,selectedChatType,userInfo,selectedChatMessages,setSelectedChatMessages,setIsDownloading,setFileDownloadProgress}=useAppStore();
  ...
  const renderMessages = () => {
    ...
    return selectedChatMessages.map((message,index) => {
      ...
      return(
        <div key={index}>
          {
            showDate &&  (<div className="text-center text-grey-500 my-2">
              {
...
{message?.messageType === "file" && message?.fileUrl && (
...
)}
  {
    message.sender._id !== userInfo.id ? <div className="flex items-center justify-start gap-3">
      <Avatar className="h-8 w-8  relative flex items-center justify-center overflow-hidden rounded-full">
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w[70vw] xl:w-[80vw] w-full">
      ...
      <div ref={scrollRef}>
        {
          showImage && <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-l flex-col">
            <div>
